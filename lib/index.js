...
function getConfig() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        let { url, username, password, projectId, outDir = './src/assets/iconfont', language = 'js' } = (_a = require((0, utils_1.getRootFilePath)('./package.json')).iconfont) !== null && _a !== void 0 ? _a : {};
