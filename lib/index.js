...
function getIconfontCss(fontFamilyClass) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const [css] = (_a = cssStr.match(reg)) !== null && _a !== void 0 ? _a : [];
            const cssObj = (_b = css2json(css)['.iconfont']) !== null && _b !== void 0 ? _b : {};
            const { className = '.iconfont', values = {} } = fontFamilyClass !== null && fontFamilyClass !== void 0 ? fontFamilyClass : {};
            Object.assign(cssObj, values);
            const newCss = Object.entries(cssObj)
                .filter(([, value]) => !(0, utils_1.isVoid)(value))
                .sort(([k1], [k2]) => k1.length - k2.length)
                .map(([k, v]) => `${k}: ${v}`)
                .join(';');
            cssStr = cssStr.replace(RegExp.$1, `${className}{ ${newCss} }\r\n`);
            log_1.default.info('正在创建 iconfont.css 文件');
            (0, utils_1.createFile)(config.iconCssPath, cssStr, 'css');
        }
        catch (error) {
            console.error(error);
        }
...
function getIconName() {
  ...
  export default {\r\n`;
    ...
    `;
        ...
        log_1.default.info('正在创建 入口 文件');
        (0, utils_1.createFile)(filePath, contentFont, 'typescript');
...
function getConfig() {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        let { url, ctoken, projectId, userInfoPath, language = 'js', fontFamilyClass, EGG_SESS_ICONFONT, outDir = './src/assets/iconfont' } = (_a = require((0, utils_1.getRootFilePath)('./package.json')).autoIconfont) !== null && _a !== void 0 ? _a : {};
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            log_1.default.clear();
            const fontFamilyClass = yield getConfig(); // 读取 项目配置信息
